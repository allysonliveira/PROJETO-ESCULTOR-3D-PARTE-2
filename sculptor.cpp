...
// definição da função putEllipsoid
...
// definição da função cutEllipsoid
...
void Sculptor::putSphere(int xcenter, int ycenter, int zcenter, int radius){
    ...
    // gera a esfera atraves da funcao putEllipsoid, com o raio único
    putEllipsoid(xcenter,ycenter,zcenter,radius,radius,radius);
}

//definição da função cutSphere
void Sculptor::cutSphere(int xcenter, int ycenter, int zcenter, int radius){

    // desativa a esfera atraves da funcao cutEllipsoid, com o raio único
